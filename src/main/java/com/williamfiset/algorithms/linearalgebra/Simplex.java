...
public class Simplex {
  ...
  // 4) Add positive coefficient artificial variable on LHS of any >= inequality
  // and any = equality.
  //
  ...
  // resulting matrix and remove the artificial variable columns and replace
  // function
  // to maximise with original and run simplex again. If maximum value of simplex
  // with
  // artificial variables is non-zero there is no solution. First column of m is
  // the constants
  // on the RHS of all constraints. First row is the expression to maximise with
  // all
