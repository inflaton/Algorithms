...
public class EditDistance {
	...
	public EditDistance(String a, String b, int insertionCost, int deletionCost, int substitutionCost) {
		if (a == null || b == null) {
	...
	// TODO(william): Define whether we're transforming a into b, or b into b. That
	// should matter,
	// right??
	...
	public static int micahEditDistance(String a, String b, int insertionCost, int deletionCost, int substitutionCost) {
