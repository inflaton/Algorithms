...
class SkipList {
	...
	/**
	 * This function creates a new skip list with the specified height and minimum
	 * and maximum values.
	 */
	...
	/**
	 * Remove a the number from the list with the given value. Returns true if value
