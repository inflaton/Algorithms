...
public class MinQueryAssignUpdateSegmentTree {
  ...
  // * Returns the range query value of the range [l, r]
  // *
  // * <p>An alternative implementation of the range query function that
  // intelligently only digs
  // into
  // * the branches of the segment tree which overlap with the query [l, r].
  // *
  // * <p>This version of the range query implementation has the advantage that it
  // doesn't need to
  ...
  // // Propagates ahead so that when you lookup a value of a node it's already
  // pre-propagated
  // // in a sense. Cleans up the code a bit. You don't want to call this method
  // on the leaf nodes.
