...
public class GenericSegmentTree3 {
  ...
  // // When updating the value of a specific index position, or a range of
  // values,
  // // modify the affected values using the following function:
  // public static enum RangeUpdateFn {
  // // When a range update is issued, assign all the values in the range [l, r]
  // to be `x`
  // ASSIGN,
  // // When a range update is issued, add a value of `x` to all the elements in
  // the range [l, r]
  // ADDITION,
  // // When a range update is issued, multiply all elements in the range [l, r]
  // by a value of `x`
  // MULTIPLICATION
  // }

  // // TODO(william): Make this class static if possible to avoid sharing members
  // with parent ST
  // class
  // private class SegmentNode implements PrintableNode {
  // // TODO(william): investigate if we really need this, it's unlikely that we
  // do since it
  // should
  ...
  // // Apply the delta value to the current node and push it to the child
  // segments
  ...
  // throw new IllegalArgumentException("Please specify a valid segment
  // combination function.");
  // }
  // if (rangeUpdateFunction == null) {
  // throw new IllegalArgumentException("Please specify a valid range update
  // function.");
  // }
  // n = values.length;
  ...
  // segments, so we
  // should
  // // be able to reduce the space, but may need to reorganize the tree/queries.
  // One idea is to
  // use
