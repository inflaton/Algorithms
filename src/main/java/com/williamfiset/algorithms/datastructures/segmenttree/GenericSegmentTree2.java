...
public class GenericSegmentTree2 {
	...
	private static void minQuerySumUpdate() {
		// 0, 1, 2, 3, 4
		long[] v = { 2, 1, 3, 4, -1 };
		GenericSegmentTree2 st = new GenericSegmentTree2(v, SegmentCombinationFn.MIN, RangeUpdateFn.ADDITION);
	...
	private static void sumQuerySumUpdateExample() {
		// 0, 1, 2, 3, 4
		long[] v = { 2, 1, 3, 4, -1 };
		GenericSegmentTree2 st = new GenericSegmentTree2(v, SegmentCombinationFn.SUM, RangeUpdateFn.ADDITION);
	...
	private static void minQueryAssignUpdateExample() {
		// 0, 1, 2, 3, 4
		long[] v = { 2, 1, 3, 4, -1 };
		GenericSegmentTree2 st = new GenericSegmentTree2(v, SegmentCombinationFn.MIN, RangeUpdateFn.ASSIGN);
