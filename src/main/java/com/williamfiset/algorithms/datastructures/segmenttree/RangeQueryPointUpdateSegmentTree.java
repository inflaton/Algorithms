...
public class RangeQueryPointUpdateSegmentTree {
	...
	public RangeQueryPointUpdateSegmentTree(long[] values, SegmentCombinationFn segmentCombinationFunction) {
	 ...
	 *
	 * <p>
	 * An alternative implementation of the range query function that intelligently
	 * only digs into the branches of the segment tree which overlap with the query
	 * [l, r].
	 *
	 * <p>
	 * This version of the range query implementation has the advantage that it
	 * doesn't need to know the explicit base case value for each range query type.
	 *
	 * @param i  the index of the current segment in the tree
	 * @param tl the left endpoint (inclusive) of the current segment
	 * @param tr the right endpoint (inclusive) of the current segment
	...
	private long rangeQuery2(int i, int tl, int tr, int l, int r) {
		...
		int tm = (tl + tr) / 2;
		// Test how the left and right segments of the interval [tl, tr] overlap with
		// the query [l, r]
	...
	private static void rangeSumQueryExample() {
		// 0 1 2 3
		long[] values = { 1, 2, 3, 2 };
		RangeQueryPointUpdateSegmentTree st = new RangeQueryPointUpdateSegmentTree(values, SegmentCombinationFn.SUM);
	...
	private static void rangeMinQueryExample() {
		// 0 1 2 3
		long[] values = { 1, 2, 3, 2 };
		RangeQueryPointUpdateSegmentTree st = new RangeQueryPointUpdateSegmentTree(values, SegmentCombinationFn.MIN);
	...
	private static void rangeMaxQueryExample() {
		// 0 1 2 3
		long[] values = { 1, 2, 3, 2 };
		RangeQueryPointUpdateSegmentTree st = new RangeQueryPointUpdateSegmentTree(values, SegmentCombinationFn.MAX);
