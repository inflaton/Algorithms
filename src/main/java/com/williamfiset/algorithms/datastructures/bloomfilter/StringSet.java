...
public class StringSet {
  ...
  // which are in the range between [32, 127). We also need to add +1 to our
  // alphabet
  // size because we're going to redefine the first ASCII character (the space
  // character)
  ...
  // More primes: 1009, 1013, 1019, 10007, 10009, 10037, 100003, 100019, 100043,
  // 1000003, 1000033,
  // 1000037,
  // 10000019, 10000079, 10000103, 100000007, 100000009, 100000023, 1000000007,
  // 1000000009,
  ...
  // mods - The mod values to use for the bloom filter, they should probably be
  // prime numbers
  ...
  // Given a rolling hash x_n*A^n + x_n-1*A^(n-1) + ... + x_2*A^2 + x_1*A^1 +
  // x_0*A^0
