...
public class NChooseRModPrime {
  ...
  public static long compute(int N, int R, int P) {
    ...
    return (factorial[N] * ModularInverse.modInv(factorial[R], P) % P
        * ModularInverse.modInv(factorial[N - R], P) % P) % P;
  }

  // Method for testing output against the output generated by the
  // compute(int,int,int) function
