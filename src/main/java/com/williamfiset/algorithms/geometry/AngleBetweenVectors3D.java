...
public class AngleBetweenVectors3D {
  ...
  public static double angleBetweenVectors(double v1x, double v1y, double v1z, double v2x,
  ...
  public static void main(String[] args) {
    System.out
        .println("Angle between  (1,1,0),  (1,1,1): " + angleBetweenVectors(1, 1, 0, 1, 1, 1));
    System.out
        .println("Angle between  (5,5,5),  (5,5,5): " + angleBetweenVectors(5, 5, 5, 5, 5, 5));
    System.out.println(
        "Angle between  (-5,-5,-5),  (-5,-5,-5): " + angleBetweenVectors(-5, -5, -5, -5, -5, -5));
    System.out.println(
        "Angle between  (2,2,2),  (-1,-1,-1): " + angleBetweenVectors(2, 2, 2, -1, -1, -1));
    System.out
        .println("Angle between  (4,-6,5), (-3,7,12): " + angleBetweenVectors(4, -6, 5, -3, 7, 12));
  }
}
