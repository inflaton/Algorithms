...
public class LongestCommonSubstring {
	...
	// Method to add unique sentinels. Works for low number of strings. Only used
	// for debugging.
	...
	public abstract static class SuffixArray {
		...
		private static Color findColorFromPos(int pos, List<Integer> sentinelIndexes) {
			Color[] colors = { Color.GREEN, Color.RED, Color.BLUE, Color.YELLOW, Color.MAGENTA, Color.CYAN, Color.WHITE,
		...
		private enum Color {
			...
			MAGENTA("\033[0;35m"), CYAN("\033[0;36m"), WHITE("\033[0;37m"), BLACK_BACKGROUND_BRIGHT("\033[0;100m");
