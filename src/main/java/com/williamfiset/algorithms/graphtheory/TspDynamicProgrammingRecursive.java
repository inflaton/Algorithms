 ...
 *
 * <p>
 * For example, if one permutation is: '... D A B C' then later when we need to compute the value of
 * the permutation '... E B A C' we should already have cached the answer for the subgraph
