...
public class SteinerTree {
	 ...
	 * connected, this method mutates the given matrix in order to give the shortest
	 * distance between all pairs of nodes. Double.NEGATIVE_INFINITY is used to
	 * indicate that the edge between node i and node j is part of a negative cycle.
	 *
	 * <p>
	 * NOTE: Usually the diagonal of the adjacency matrix is all zeros (i.e.
	 * distance[i][i] = 0 for all i) since there is typically no cost to go from a
	...
	public static void main(String[] args) {
		 ...
		 * [O] / \ 3 4 / \ [1] [2] | | 5 6 | | [3] [4]
		 */
		double[][] matrix1 = new double[][] { { 0, 3, 4, INF, INF }, { 3, 0, INF, 5, INF }, { 4, INF, 0, INF, 6 },
				{ INF, 5, INF, 0, INF }, { INF, INF, 6, INF, 0 } };
		 ...
		 */
		double[][] matrix2 = new double[][] { { 0, 3, 5, INF, INF, INF }, { 3, 0, INF, 4, INF, INF },
				{ 5, INF, 0, INF, 7, 8 }, { INF, 4, INF, 0, INF, 1 }, { INF, INF, 7, INF, 0, 2 },
				{ INF, INF, 8, 1, 2, 0 } };
