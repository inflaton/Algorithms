...
public class GenericSegmentTreeTest {
	...
	// assertThat(st.rangeQuery1(0, 4)).isEqualTo(2 * 5 + 2 * 2 + 3 * 5 + 1 + 1 + 1
	// + 2 + 2);
	// }
	...
	// assertThat(st.rangeQuery1(1, 3)).isEqualTo(4 * 3 * 2 + 5 * 3 * 2 + 3 * 3 *
	// 2);
	// }
	...
	// // assertThat(st.rangeQuery1(0, 4)).isEqualTo(2); // Returns -8 as max but
	// should be 2
	// }

	@Test
	public void testAllFunctionCombinations() {
		GenericSegmentTree.SegmentCombinationFn[] combinationFns = { GenericSegmentTree.SegmentCombinationFn.SUM,
				GenericSegmentTree.SegmentCombinationFn.MIN, GenericSegmentTree.SegmentCombinationFn.MAX,
