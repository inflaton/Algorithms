...
public class GenericSegmentTree2Test {
	...
	public void testSumQuerySumUpdate_Simple() {
		...
		GenericSegmentTree2 st = new GenericSegmentTree2(values, GenericSegmentTree2.SegmentCombinationFn.SUM,
	...
	public void testSumQuerySumUpdate_RangeUpdate() {
		// 0, 1, 2, 3, 4
		long[] ar = { 1, 2, 1, 2, 1 };
		GenericSegmentTree2 st = new GenericSegmentTree2(ar, GenericSegmentTree2.SegmentCombinationFn.SUM,
				GenericSegmentTree2.RangeUpdateFn.ADDITION);
	...
	public void minQuerySumUpdates_simple() {
		long[] ar = { 2, 1, 3, 4, -1 };
		GenericSegmentTree2 st = new GenericSegmentTree2(ar, GenericSegmentTree2.SegmentCombinationFn.MIN,
				GenericSegmentTree2.RangeUpdateFn.ADDITION);
	...
	public void maxQuerySumUpdate_simple() {
		long[] ar = { 2, 1, 3, 4, -1 };
		GenericSegmentTree2 st = new GenericSegmentTree2(ar, GenericSegmentTree2.SegmentCombinationFn.MAX,
				GenericSegmentTree2.RangeUpdateFn.ADDITION);
	...
	public void maxminQueryMulUpdate_simple() {
		long[] ar = { 2, 1, 3, 4, -1 };
		GenericSegmentTree2 st1 = new GenericSegmentTree2(ar, GenericSegmentTree2.SegmentCombinationFn.MAX,
				GenericSegmentTree2.RangeUpdateFn.MULTIPLICATION);
		GenericSegmentTree2 st2 = new GenericSegmentTree2(ar, GenericSegmentTree2.SegmentCombinationFn.MIN,
				GenericSegmentTree2.RangeUpdateFn.MULTIPLICATION);
	...
	public void minQueryMulUpdate_simple() {
		long[] ar = { 2, 1, 3, 4, -1 };
		GenericSegmentTree2 st1 = new GenericSegmentTree2(ar, GenericSegmentTree2.SegmentCombinationFn.MIN,
				GenericSegmentTree2.RangeUpdateFn.MULTIPLICATION);
	...
	public void testAllFunctionCombinations() {
		GenericSegmentTree2.SegmentCombinationFn[] combinationFns = { GenericSegmentTree2.SegmentCombinationFn.SUM,
				GenericSegmentTree2.SegmentCombinationFn.MIN, GenericSegmentTree2.SegmentCombinationFn.MAX, };

		GenericSegmentTree2.RangeUpdateFn[] rangeUpdateFns = { GenericSegmentTree2.RangeUpdateFn.ADDITION,
				GenericSegmentTree2.RangeUpdateFn.ASSIGN, GenericSegmentTree2.RangeUpdateFn.MULTIPLICATION };

		for (GenericSegmentTree2.SegmentCombinationFn combinationFn : combinationFns) {
			for (GenericSegmentTree2.RangeUpdateFn rangeUpdateFn : rangeUpdateFns) {

				// TODO(issue/208): The multiplication range update function seems to be
				// suffering
				// from overflow issues and not being able to handle negative numbers.
				//
				// One idea might be to also track the min value for the max query and vice
				// versa
