...
public class KosarajuTest {
	...
	public void testDisjointTree() {
		...
		List<List<Integer>> expectedSccs = ImmutableList.of(ImmutableList.of(0), ImmutableList.of(1),
				ImmutableList.of(2), ImmutableList.of(3), ImmutableList.of(4), ImmutableList.of(5),
				ImmutableList.of(6));
	...
	public void testDisjointTreeFromHackerrank() {
		...
		List<List<Integer>> expectedSccs = ImmutableList.of(ImmutableList.of(0), ImmutableList.of(2),
				ImmutableList.of(3), ImmutableList.of(4), ImmutableList.of(5), ImmutableList.of(6), ImmutableList.of(7),
				ImmutableList.of(8), ImmutableList.of(9), ImmutableList.of(10), ImmutableList.of(1, 11, 12),
				ImmutableList.of(13), ImmutableList.of(14), ImmutableList.of(15));
	...
	public void testFirstGraphInSlides() {
		...
		List<List<Integer>> expectedSccs = ImmutableList.of(ImmutableList.of(0, 1, 8), ImmutableList.of(7, 6),
				ImmutableList.of(2, 3, 5), ImmutableList.of(4));
	...
	public void testLastGraphInSlides() {
		...
		List<List<Integer>> expectedSccs = ImmutableList.of(ImmutableList.of(6, 5, 4), ImmutableList.of(3, 7),
