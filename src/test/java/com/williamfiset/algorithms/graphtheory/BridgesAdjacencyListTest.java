...
public class BridgesAdjacencyListTest {
	...
	public void testTreeCase() {
		...
		List<Pair<Integer, Integer>> expected = ImmutableList.of(Pair.of(0, 1), Pair.of(0, 2), Pair.of(2, 5),
				Pair.of(5, 6), Pair.of(5, 11), Pair.of(4, 5), Pair.of(4, 10), Pair.of(3, 4), Pair.of(3, 7),
	...
	public void graphWithCyclesTest() {
		...
		List<Pair<Integer, Integer>> expected = ImmutableList.of(Pair.of(3, 7), Pair.of(7, 8), Pair.of(7, 9),
				Pair.of(4, 10));
	...
	public void testDisconnectedGraph() {
		...
		List<Pair<Integer, Integer>> expected = ImmutableList.of(Pair.of(0, 1), Pair.of(1, 2), Pair.of(3, 4),
				Pair.of(7, 8), Pair.of(8, 9), Pair.of(8, 10));
