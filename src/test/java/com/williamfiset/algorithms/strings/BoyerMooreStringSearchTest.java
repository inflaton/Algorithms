...
public class BoyerMooreStringSearchTest {
	...
	public void shouldReturnOneOccurrence() {
		assertThat(underTest.findOccurrences("Sample text for testing the Boyer-Moore algorithm.", "Sample"))
				.containsExactly(0);
		assertThat(underTest.findOccurrences("Sample text for testing the Boyer-Moore algorithm.", "for"))
				.containsExactly(12);
	...
	public void shouldReturnMultipleOccurrences() {
		...
		assertThat(underTest.findOccurrences("Sample text for testing the Boyer-Moore algorithm.", "te"))
	...
	public void shouldReturnEmptyForPatternLengthLargerThenText() {
		assertThat(underTest.findOccurrences("This is a Test Text", "This is a test Pattern")).isEmpty();
	}
	...
	public void shouldReturnDynamicString() {
		...
		for (int run = 0; run < runLength; run++) {
			...
			int maxLengthText = random.nextInt(1000) + 100; // random length of the string between [100=1000]
